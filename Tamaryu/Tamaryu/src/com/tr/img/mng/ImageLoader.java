...
public class ImageLoader {
	...
	public ImageLoader(boolean global) {
	...
	public boolean isSpriteSheet(String name){
		return isSpriteSheet(getFileIfExists(name));
	}
	...
	public boolean isGifAnimation(String name){
		return isGifAnimation(getFileIfExists(name));
	}
